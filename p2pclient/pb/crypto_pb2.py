...
# source: p2pclient/pb/crypto.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='p2pclient/pb/crypto.proto',
  package='p2pclient.crypto.pb',
  syntax='proto2',
  serialized_pb=_b('\n\x19p2pclient/pb/crypto.proto\x12\x13p2pclient.crypto.pb\"I\n\tPublicKey\x12.\n\x08key_type\x18\x01 \x02(\x0e\x32\x1c.p2pclient.crypto.pb.KeyType\x12\x0c\n\x04\x64\x61ta\x18\x02 \x02(\x0c\"J\n\nPrivateKey\x12.\n\x08key_type\x18\x01 \x02(\x0e\x32\x1c.p2pclient.crypto.pb.KeyType\x12\x0c\n\x04\x64\x61ta\x18\x02 \x02(\x0c*9\n\x07KeyType\x12\x07\n\x03RSA\x10\x00\x12\x0b\n\x07\x45\x64\x32\x35\x35\x31\x39\x10\x01\x12\r\n\tSecp256k1\x10\x02\x12\t\n\x05\x45\x43\x44SA\x10\x03')
)

_KEYTYPE = _descriptor.EnumDescriptor(
  name='KeyType',
  full_name='p2pclient.crypto.pb.KeyType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_PUBLICKEY = _descriptor.Descriptor(
  name='PublicKey',
  full_name='p2pclient.crypto.pb.PublicKey',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key_type', full_name='p2pclient.crypto.pb.PublicKey.key_type', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='data', full_name='p2pclient.crypto.pb.PublicKey.data', index=1,
...
_PRIVATEKEY = _descriptor.Descriptor(
  name='PrivateKey',
  full_name='p2pclient.crypto.pb.PrivateKey',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key_type', full_name='p2pclient.crypto.pb.PrivateKey.key_type', index=0,
      number=1, type=14, cpp_type=8, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='data', full_name='p2pclient.crypto.pb.PrivateKey.data', index=1,
      number=2, type=12, cpp_type=9, label=2,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
PublicKey = _reflection.GeneratedProtocolMessageType('PublicKey', (_message.Message,), dict(
  ...
  __module__ = 'p2pclient.pb.crypto_pb2'
  # @@protoc_insertion_point(class_scope:p2pclient.crypto.pb.PublicKey)
  ))
...
PrivateKey = _reflection.GeneratedProtocolMessageType('PrivateKey', (_message.Message,), dict(
  ...
  __module__ = 'p2pclient.pb.crypto_pb2'
  # @@protoc_insertion_point(class_scope:p2pclient.crypto.pb.PrivateKey)
  ))
