...
async def test_pubsub_client_subscribe(p2pds):
    ...
    _, _ = await p2pds[0].pubsub.subscribe(another_topic)
    reader_1_another, _ = await p2pds[1].pubsub.subscribe(another_topic)
    ...
    reader_2, _ = await p2pds[2].pubsub.subscribe(topic)
